...
<a class="btn  btn-danger bg-gradient p-2 bd-highlight shadow mb-3" style="width:200px" href="{{ url('admin_exceed') }}">返却期限超過者リスト</a>
<a class="btn  btn-danger bg-gradient p-2 bd-highlight shadow mb-3" style="width:200px" href="{{ url('admin_UpClose') }}">返却期限間近者リスト</a>
