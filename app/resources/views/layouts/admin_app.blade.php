...
<head>
    ...
    <nav class="navbar nav-header navbar-expand-md navbar-light bg-light bg-gradient shadow">
        <div class="collapse navbar-collapse" id="navbarNav">
             <ul class="navbar-nav">
                <li class="nav-item">
                    ...
                    <a class=" rogo" href="{{ url('/admin/home') }}">
                    AcialLibrary
                    </a>
                </li>
            </ul>
        ...
        @else
            <a class="my-navber-item" href="{{ route('admin.register') }}">管理者新規会員登録</a>
        @endif
    </nav> 
    @else
    <nav class="navbar nav-header navbar-expand-md navbar-light bg-light bg-gradient shadow">
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                <a class="dropdown-item" href="{{ route('admin.admin.edit',['admin' => Auth::id()],'edit') }}">アカウント情報変更</a>
                </li>
            </ul>
            <ul class="navbar-nav">
                <li class="nav-item">
                ...
                @else
                    <a class="my-navber-item" href="{{ route('admin.register') }}">会員登録</a>
                @endif
                </li>
            </ul>
        </div>
